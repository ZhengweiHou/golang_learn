...
func NewNacosResolver(cli naming_client.INamingClient, opts ...Option) discovery.Resolver {
	...
	return &HzwNacosResolver{cli: cli, opts: op}
}

// Target return a description for the given target that is suitable for being a key for cache.
func (n *HzwNacosResolver) Target(_ context.Context, target rpcinfo.EndpointInfo) (description string) {
	return target.ServiceName()
}

// Resolve a service info by desc.
func (n *HzwNacosResolver) Resolve(_ context.Context, desc string) (discovery.Result, error) {
...
func (n *HzwNacosResolver) Diff(cacheKey string, prev, next discovery.Result) (discovery.Change, bool) {
	return discovery.DefaultDiff(cacheKey, prev, next)
}

// Name returns the name of the resolver.
func (n *HzwNacosResolver) Name() string {
	return "nacos" + ":" + n.opts.cluster + ":" + n.opts.group
}

var _ discovery.Resolver = (*HzwNacosResolver)(nil)
