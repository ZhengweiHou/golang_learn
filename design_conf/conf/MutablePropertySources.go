...
type MutablePropertySources struct {
	...
	// propertySourceList []IPropertySource // TODO 安全性优化，需要实现为CopyOnWrite模式
	propertySourceList *extutil.CopyOnWriteSlice[IPropertySource]
}

func NewMutablePropertySources() *MutablePropertySources {
	return &MutablePropertySources{
		lock:               sync.Mutex{},
		propertySourceList: extutil.NewCopyOnWriteSlice[IPropertySource](),
	}
}
